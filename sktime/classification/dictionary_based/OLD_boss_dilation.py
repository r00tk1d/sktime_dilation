...
__all__ = ["OLDBOSSEnsembleDilation", "OLDIndividualBOSSDilation", "boss_distance"]
...
class OLDBOSSEnsembleDilation(BaseClassifier):
    ...
    def __init__(
        ...
        super(OLDBOSSEnsembleDilation, self).__init__()
...
class OLDIndividualBOSSDilation(BaseClassifier):
    ...
    def __init__(
        ...
        super(OLDIndividualBOSSDilation, self).__init__()
    ...
    def _predict(self, X):
        ...
        # TODO dilation methode
        X_dilated = self.dilation(X, self.dilation_size)

        test_bags = self._transformer.transform(X_dilated)
    ...
    def _shorten_bags(self, word_len):
        new_boss = IndividualBOSSDilation(
            self.window_size,
            word_len,
            self.norm,
            self.alphabet_size,

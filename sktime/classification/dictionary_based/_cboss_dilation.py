# -*- coding: utf-8 -*-
"""ContractableBOSSDilation classifier.
...
__all__ = ["ContractableBOSSDilation", "pairwise_distances"]
...
from sktime.classification.dictionary_based import IndividualBOSSDilation
from sktime.classification.dictionary_based._boss import pairwise_distances
from sktime.utils.validation.panel import check_X_y


class ContractableBOSSDilation(BaseClassifier):
    ...
    def __init__(
        ...
        feature_selection="none", #{"chi2", "none", "random"}
    ...
    def _fit(self, X, y):
        ...
        if self.min_window > max_window + 1:
            raise ValueError(
                f"Error in ContractableBOSSDilation, min_window ="
    ...
    def _unique_parameters(self, max_window, win_inc):
        possible_parameters = [
            ...
            for h, win_size in enumerate(self.win_lengths)

...
__all__ = ["BOSSEnsembleDilation", "IndividualBOSSDilation", "pairwise_distances"]
...
class BOSSEnsembleDilation(BaseClassifier):
...
class IndividualBOSSDilation(BaseClassifier):
    ...
    def __init__(
        ...
        n_jobs=1,
        random_state=None,
        dilation_size=1, # 1 heißt keine dilation
    ...
    def _fit(self, X, y):
        ...
        self._transformed_data = self._transformer.fit_transform(X_dilated, y)

...
__all__ = ["TimeSeriesForestClassifierDilationReal"]
...
class TimeSeriesForestClassifierDilationReal(
    BaseTimeSeriesForestDilationReal, ForestClassifier, BaseClassifier
):
    ...
    def __init__(
        ...
        super(TimeSeriesForestClassifierDilationReal, self).__init__(
            min_interval=min_interval,
            n_estimators=n_estimators,
            n_jobs=n_jobs,
            random_state=random_state,

            max_dilation_size=max_dilation_size,
    ...
    def _fit(self, X, y):
        BaseTimeSeriesForestDilationReal._fit(self, X=X, y=y)
